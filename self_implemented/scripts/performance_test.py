...
service_swarm_name = 'micro_swarm'
...
def perform_run(request_count):
    print('running request_count=' + str(request_count) + ' resource_constraints=' + str(with_resource_constraints))
    clear_img_dir()
    setup_img_dir()
    create_tasks(request_count)
    try:
        processing_time = time_till_all_tasks_done(request_count)
        res = str(request_count) + ";" + str(with_resource_constraints) + ';' + str(processing_time)
    except:
        print('timed out')
        res = str(request_count) + ";" + str(with_resource_constraints) + ';' + 'timeout'
