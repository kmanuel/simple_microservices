...
func startPrometheus() {
	...
	var addr = flag.String("listen-address", ":"+os.Getenv("SCREENSHOT_SERVICE_PROMETHEUS_PORT"), "The address to listen on for HTTP requests.")
	flag.Parse()
...
func startExternalApi(statusClient status_client.StatusClient, fs service.FaktoryPublishService) {
	...
	fmt.Println(http.ListenAndServe(":"+os.Getenv("SCREENSHOT_SERVICE_EXTERNAL_PORT"), nil))
}
