...
import (
	...
	"github.com/kmanuel/simple_microservices/go_kit/service/screenshot/src/middleware"
	"github.com/kmanuel/simple_microservices/go_kit/service/screenshot/src/service"
	"github.com/kmanuel/simple_microservices/go_kit/service/screenshot/src/transport"
...
func main() {
	...
	imageService = service.NewScreenshotService(minioService)
